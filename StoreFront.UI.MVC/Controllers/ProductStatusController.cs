...
namespace StoreFront.UI.MVC.Controllers
{
    ...
    public class ProductStatusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductStatusId,ProductStatus1")] ProductStatus productStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductStatusId,ProductStatus1")] ProductStatus productStatus)
        {
